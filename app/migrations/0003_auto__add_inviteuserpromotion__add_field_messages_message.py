...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InviteUserPromotion'
        db.create_table('app_inviteuserpromotion', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('message', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Messages'])),
            ('user_from', self.gf('django.db.models.fields.related.ForeignKey')(related_name='invite_user_from', to=orm['app.CustomUser'])),
            ('user_to', self.gf('django.db.models.fields.related.ForeignKey')(related_name='invite_user_to', to=orm['app.CustomUser'])),
            ('send_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('promotion', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Promotion'])),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.PromotionGroup'])),
        ))
        db.send_create_signal('app', ['InviteUserPromotion'])

        # Adding field 'Messages.message'
        db.add_column('app_messages', 'message',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'InviteUserPromotion'
        db.delete_table('app_inviteuserpromotion')

        # Deleting field 'Messages.message'
        db.delete_column('app_messages', 'message')

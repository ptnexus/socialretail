...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Retalhista.url'
        db.add_column(u'app_retalhista', 'url',
                      self.gf('django.db.models.fields.URLField')(max_length=400, null=True),
                      keep_default=False)

        # Adding field 'Retalhista.nome'
        db.add_column(u'app_retalhista', 'nome',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=80),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Retalhista.url'
        db.delete_column(u'app_retalhista', 'url')

        # Deleting field 'Retalhista.nome'
        db.delete_column(u'app_retalhista', 'nome')

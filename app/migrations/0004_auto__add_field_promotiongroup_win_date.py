...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PromotionGroup.win_date'
        db.add_column('app_promotiongroup', 'win_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PromotionGroup.win_date'
        db.delete_column('app_promotiongroup', 'win_date')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Utilizador.data_left'
        db.add_column(u'app_utilizador', 'data_left',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Utilizador.data_left'
        db.delete_column(u'app_utilizador', 'data_left')

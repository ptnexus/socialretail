...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Utilizador.foto'
        db.add_column(u'app_utilizador', 'foto',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True),
                      keep_default=False)

        # Adding field 'Retalhista.foto'
        db.add_column(u'app_retalhista', 'foto',
                      self.gf('django.db.models.fields.URLField')(max_length=400, null=True),
                      keep_default=False)

        # Adding field 'Retalhista.descricao'
        db.add_column(u'app_retalhista', 'descricao',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Utilizador.foto'
        db.delete_column(u'app_utilizador', 'foto')

        # Deleting field 'Retalhista.foto'
        db.delete_column(u'app_retalhista', 'foto')

        # Deleting field 'Retalhista.descricao'
        db.delete_column(u'app_retalhista', 'descricao')

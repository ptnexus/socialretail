...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('app_messages', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user_from', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_from', to=orm['app.CustomUser'])),
            ('user_to', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_to', to=orm['app.CustomUser'])),
        ...
        db.send_create_signal('app', ['Messages'])


    def backwards(self, orm):
        # Deleting model 'Messages'
        db.delete_table('app_messages')

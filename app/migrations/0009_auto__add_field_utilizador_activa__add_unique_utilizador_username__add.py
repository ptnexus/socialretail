...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Utilizador.activa'
        db.add_column(u'app_utilizador', 'activa',
        ...
        # Adding unique constraint on 'Utilizador', fields ['username']
        db.create_unique(u'app_utilizador', ['username'])

        # Adding unique constraint on 'Utilizador', fields ['facebookid']
        db.create_unique(u'app_utilizador', ['facebookid'])

        # Adding unique constraint on 'Utilizador', fields ['email']
        db.create_unique(u'app_utilizador', ['email'])

        # Adding unique constraint on 'Retalhista', fields ['username']
        db.create_unique(u'app_retalhista', ['username'])

        # Adding unique constraint on 'Retalhista', fields ['email']
        db.create_unique(u'app_retalhista', ['email'])


    def backwards(self, orm):
        # Removing unique constraint on 'Retalhista', fields ['email']
        db.delete_unique(u'app_retalhista', ['email'])

        # Removing unique constraint on 'Retalhista', fields ['username']
        db.delete_unique(u'app_retalhista', ['username'])

        # Removing unique constraint on 'Utilizador', fields ['email']
        db.delete_unique(u'app_utilizador', ['email'])

        # Removing unique constraint on 'Utilizador', fields ['facebookid']
        db.delete_unique(u'app_utilizador', ['facebookid'])

        # Removing unique constraint on 'Utilizador', fields ['username']
        db.delete_unique(u'app_utilizador', ['username'])

        # Deleting field 'Utilizador.activa'
        db.delete_column(u'app_utilizador', 'activa')

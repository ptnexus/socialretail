...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Campanha.url'
        db.add_column(u'app_campanha', 'url',
                      self.gf('django.db.models.fields.URLField')(max_length=400, null=True),
                      keep_default=False)

        # Adding field 'WishList.nome'
        db.add_column(u'app_wishlist', 'nome',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=80),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Campanha.url'
        db.delete_column(u'app_campanha', 'url')

        # Deleting field 'WishList.nome'
        db.delete_column(u'app_wishlist', 'nome')
